...
print(classes)
#model = torch.load("output_models/imageNet_model_25_epochs_extended_data")

#model=torch.load('output_models/imageNet_model_resNext_deep_retrain')
model = models.resnext101_32x8d(pretrained=True)
num_ftrs = model.fc.in_features
model.fc = nn.Linear(num_ftrs, len(classes))
weights = torch.load('output_models/heirarchy_models/resnext_classic_weights', map_location='cpu')
